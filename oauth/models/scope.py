...
scope_association_table = db.Table('oauth_clients_oauth_client_scopes', db.metadata,
                                   db.Column('oauth_client_id', db.Integer, db.ForeignKey('oauth_client.id')),
                                   db.Column('oauth_client_scope_id', db.Integer, db.ForeignKey('oauth_client_scope.id'))
                                   )
